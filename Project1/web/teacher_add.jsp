...
<form id="formId" class="layui-form layui-form-pane" action="">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="object" autocomplete="off" placeholder="请输入学科" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">薪水</label>
        <div class="layui-input-block">
            <input type="text" name="salary" autocomplete="off" placeholder="请输入薪水" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
...
<script>
    ...
    function submitForm() {
        $.post(
            '${pageContext.request.contextPath}/teacher?method=add',
            $('#formId').serialize(),
            function(jsonResult) {
