...
<div class="box">
    ...
    <div class="register-form">
        ...
        <div class="input-box">
            <input type="text" placeholder="用户名" id="_nameId">
            <input type="password" placeholder="密码" id="_passwordId">
            <input type="password" placeholder="确认密码" id="_passwordId1">
        </div>
    ...
    <div class="login-form">
        ...
        <div class="input-box">
            ...
            <input type="text" placeholder="用户名"  id="nameId">
            <input type="password" placeholder="密码" id="passwordId">
            <input type="text" placeholder="验证码"  id="codeId"/>
            <img id="verigyCodeId" src="${pageContext.request.contextPath}/verifyCode" onclick="refresh()"><br/>
...
<script>
    ...
    function submitForm() {
        ...
        $.get(
            ...
            {"name":nameId,"password":passwordId,"code":codeId},
            function(jsonResult) {
...
<script>
    function register() {
        var _nameId = $('#_nameId').val();
        var _passwordId = $('#_passwordId').val();
        var _password1 = $('#_passwordId').val();
        $.get(

            '${pageContext.request.contextPath}/user?method=register',
            {"name":_nameId,"password":_passwordId,"password1":_password1},
            function(jsonResult) {
                console.log(jsonResult);
                if (jsonResult.code == 0) {
                    mylayer.okUrl(jsonResult.msg, '${pageContext.request.contextPath}/login.jsp');
                    <%--mylayer.okUrl(jsonResult.msg, '${pageContext.request.contextPath}/manager/safe/ShowAllEmpController');--%>
                } else {
                    mylayer.errorMsg(jsonResult.msg);
                    <%-- mylayer.errorUrl(jsonResult.msg,'${pageContext.request.contextPath}/login.jsp');--%>
