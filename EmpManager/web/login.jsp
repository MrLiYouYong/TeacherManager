       ...
       <div class="box">
        ...
        <div class="login-form">
            ...
            <div class="input-box">
                ...
                <input type="text" placeholder="验证码" name="inputVcode" id="codeId"/>
                <img src="/empproject/CreateCodeController" id="imgId" onclick="refresh()"><br/>
        ...
        <script>
            function refresh() {
                $('#imgId').attr('src', '/empproject/CreateCodeController');
            }
        </script>
